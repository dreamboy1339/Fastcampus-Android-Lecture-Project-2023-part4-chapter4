...
//    }
    ...
    PyeongToSqureMeterStateless(
        ...
        if (it.isBlank()) {
            pyeong = ""
            squaremeter = ""
            return@PyeongToSqureMeterStateless
        }
        val numericValue = it.toFloatOrNull() ?: return@PyeongToSqureMeterStateless
        pyeong = it
        squaremeter = (numericValue * 3.306).toString()
    }
}
...
@Composable
fun PyeongToSqureMeterStateless(
    pyeong: String,
    squareMeter: String,
